...
"""Verify that starting limracoin with -h works as expected."""

from test_framework.test_framework import LimracoinTestFramework
from test_framework.util import assert_equal

class HelpTest(LimracoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start limracoin with -h for help text")
        ...
        self.log.info("Start limracoin with -version for version information")
        ...
        self.log.info("Start limracoind with -fakearg to make sure it does not start")
