...
# TestP2PConn: A peer we use to send messages to limracoind, and store responses.
...
class CompactBlocksTest(LimracoinTestFramework):
    ...
    # This test actually causes limracoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that limracoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for limracoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # limracoind will not send blocktxn responses for blocks whose height is
