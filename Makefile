...
pkgdatadir = $(datadir)/limracoin
pkgincludedir = $(includedir)/limracoin
pkglibdir = $(libdir)/limracoin
pkglibexecdir = $(libexecdir)/limracoin
...
CONFIG_HEADER = $(top_builddir)/src/config/limracoin-config.h
CONFIG_CLEAN_FILES = liblimracoinconsensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	...
	test/util/limracoin-util-test.py test/util/rpcauth-test.py
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/liblimracoinconsensus.pc.in \
	...
	$(top_srcdir)/src/config/limracoin-config.h.in \
	$(top_srcdir)/test/config.ini.in \
	$(top_srcdir)/test/functional/test_runner.py \
	$(top_srcdir)/test/util/limracoin-util-test.py \
...
ACLOCAL = ${SHELL} /home/krypto/Downloads/limra/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/krypto/Downloads/limra/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/krypto/Downloads/limra/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/krypto/Downloads/limra/build-aux/missing automake-1.15
...
COPYRIGHT_HOLDERS_FINAL = The Limracoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Limracoin Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
LIBTOOL_APP_LDFLAGS = 
LIMRACOIN_CLI_NAME = limracoin-cli
LIMRACOIN_DAEMON_NAME = limracoind
LIMRACOIN_GUI_NAME = limracoin-qt
LIMRACOIN_TX_NAME = limracoin-tx
LIPO = 
LN_S = ln -s
...
MAINT = 
MAKEINFO = ${SHELL} /home/krypto/Downloads/limra/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = limracoin
PACKAGE_BUGREPORT = https://github.com/limracoin/limracoin/issues
PACKAGE_NAME = Limracoin Core
PACKAGE_STRING = Limracoin Core 0.17.1
PACKAGE_TARNAME = limracoin
PACKAGE_URL = https://limracoincore.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/krypto/Downloads/limra
abs_srcdir = /home/krypto/Downloads/limra
abs_top_builddir = /home/krypto/Downloads/limra
abs_top_srcdir = /home/krypto/Downloads/limra
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/krypto/Downloads/limra/build-aux/install-sh
...
pkgconfig_DATA = liblimracoinconsensus.pc
LIMRACOIND_BIN = $(top_builddir)/src/$(LIMRACOIN_DAEMON_NAME)$(EXEEXT)
LIMRACOIN_QT_BIN = $(top_builddir)/src/qt/$(LIMRACOIN_GUI_NAME)$(EXEEXT)
LIMRACOIN_CLI_BIN = $(top_builddir)/src/$(LIMRACOIN_CLI_NAME)$(EXEEXT)
LIMRACOIN_TX_BIN = $(top_builddir)/src/$(LIMRACOIN_TX_NAME)$(EXEEXT)
LIMRACOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Limracoin-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/limracoin.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/limracoin-cli.bash-completion \
	       $(top_srcdir)/contrib/limracoin-tx.bash-completion \
	       $(top_srcdir)/contrib/limracoind.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/limracoin.ico \
...
COVERAGE_INFO = baseline.info \
  test_limracoin_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_limracoin_coverage.info test_limracoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/limracoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Limracoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) test/functional/test_runner.py \
	...
	test/util/limracoin-util-test.py \
	test/util/data/limracoin-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(LIMRACOIN_WIN_INSTALLER)
...
src/config/limracoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/limracoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/limracoin-config.h
$(top_srcdir)/src/config/limracoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/limracoin-config.h src/config/stamp-h1
liblimracoinconsensus.pc: $(top_builddir)/config.status $(srcdir)/liblimracoinconsensus.pc.in
...
$(LIMRACOIN_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(LIMRACOIND_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(LIMRACOIN_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(LIMRACOIN_CLI_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(LIMRACOIN_TX_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/limracoin.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Limracoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $(LIMRACOIN_QT_BIN) $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Limracoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Limracoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#deploy: $(OSX_DMG)
#deploy: $(LIMRACOIN_WIN_INSTALLER)

$(LIMRACOIN_QT_BIN): FORCE
	$(MAKE) -C src qt/$(@F)

$(LIMRACOIND_BIN): FORCE
	$(MAKE) -C src $(@F)

$(LIMRACOIN_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)

$(LIMRACOIN_TX_BIN): FORCE
	$(MAKE) -C src $(@F)
...
#test_limracoin.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_limracoin -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_limracoin_filtered.info: test_limracoin.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_limracoin_filtered.info
...
#test_limracoin_coverage.info: baseline_filtered.info test_limracoin_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_limracoin_filtered.info -o $@

#total_coverage.info: test_limracoin_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_limracoin_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_limracoin.coverage/.dirstamp:  test_limracoin_coverage.info
...
#cov: test_limracoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_limracoin.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
