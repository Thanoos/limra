...
* limracoin.conf: contains configuration settings for limracoind or limracoin-qt
* limracoind.pid: stores the process id of limracoind while running
...
* debug.log: contains debug information and general logging generated by limracoind or limracoin-qt
