Download URL: https://sourceforge.net/projects/limracoin/files/Limracoin/limracoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LIM fee schedule (users still pay 0.01 LIM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #limracoin00 - #limracoin99
