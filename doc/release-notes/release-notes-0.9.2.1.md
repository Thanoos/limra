Limracoin Core version 0.9.2.1 is now available from:

  https://limracoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LIM to 0.01 LIM
...
- Fix "Start limracoin on system login"
