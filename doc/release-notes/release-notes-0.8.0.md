Limracoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/limracoin/files/Limracoin/limracoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Limracoin
...
New/changed settings (command-line or limracoin.conf file)
--------------------------------------------------------
