Limracoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/limracoin/files/Limracoin/limracoin-0.5.4/
...
http://gitorious.org/limracoin/limracoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Limracoin-Qt notifications under Growl 1.3.
Increase required age of Limracoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLimracoin properly when installing Limracoin-Qt over it. (Windows)
