Limracoin Core version 0.16.1 is now available from:

  <https://limracoincore.org/bin/limracoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting limracoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure limracoind processes are cleaned up when tests end (sdaftuar)
