Limracoin Core version 0.9.4 is now available from:

  https://limracoin.org/bin/0.9.4/
...
this update is incompatible with the Limracoin system and could lead to consensus
forks.

Limracoin Core released binaries from https://limracoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~limracoin/+archive/ubuntu/limracoin
- A third-party or self-compiled Limracoin Core

upgrade to Limracoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
