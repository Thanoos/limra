Limracoin Core version 0.13.2 is now available from:

  <https://limracoin.org/bin/limracoin-core-0.13.2/>
...
- #8908 `4a974b2` Update limracoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow limracoin-tx to create v2 transactions (limdrak)
