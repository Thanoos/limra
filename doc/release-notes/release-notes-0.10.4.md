Limracoin Core version 0.10.4 is now available from:

  <https://limracoin.org/bin/limracoin-core-0.10.4/>
...
- #6953 `43c2789` Split limracoin-tx into its own package
- #6953 `dfe0d4d` Include limracoin-tx binary on Debian/Ubuntu
