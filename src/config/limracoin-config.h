/* src/config/limracoin-config.h.  Generated from limracoin-config.h.in by configure.  */
/* src/config/limracoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LIMRACOIN_CONFIG_H

#define LIMRACOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Limracoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Limracoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/limracoin/limracoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Limracoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Limracoin Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "limracoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://limracoincore.org/"
