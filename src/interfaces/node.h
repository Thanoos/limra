...
#ifndef LIMRACOIN_INTERFACES_NODE_H
#define LIMRACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a limracoin node (limracoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LIMRACOIN_INTERFACES_NODE_H
