...
#ifndef LIMRACOIN_TEST_SCRIPTNUM10_H
#define LIMRACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Limracoin Core 0.10.0, for cross-comparison.
 */
public:
