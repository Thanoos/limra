...
#ifndef LIMRACOIN_KEYSTORE_H
#define LIMRACOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/limracoin/bips/blob/master/bip-0013.mediawiki
