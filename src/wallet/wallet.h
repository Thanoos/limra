...
#ifndef LIMRACOIN_WALLET_WALLET_H
#define LIMRACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this limracoin node, and set to 0 for transactions that were created
...
#endif // LIMRACOIN_WALLET_WALLET_H
