 ...
 */
#ifndef LIMRACOIN_UTIL_H
#define LIMRACOIN_UTIL_H
...
extern const char * const LIMRACOIN_CONF_FILENAME;
extern const char * const LIMRACOIN_PID_FILENAME;
...
{
    std::string s = strprintf("limracoin-%s", name);
