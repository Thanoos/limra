...
#ifndef LIMRACOIN_QT_SPLASHSCREEN_H
#define LIMRACOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Limracoin Core initialization
...
#endif // LIMRACOIN_QT_SPLASHSCREEN_H
