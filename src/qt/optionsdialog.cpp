    ...
    mapper(0)
{
    ...
    ui->limracoinAtStartup->setToolTip(ui->limracoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->limracoinAtStartup->setText(ui->limracoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openLimracoinConfButton->setToolTip(ui->openLimracoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LimracoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->limracoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLimracoinConfButton_clicked()
{
