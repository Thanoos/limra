...
#ifndef LIMRACOIN_QT_LIMRACOINUNITS_H
#define LIMRACOIN_QT_LIMRACOINUNITS_H
...
/** Limracoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LimracoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LimracoinUnits(QObject *parent);

    /** Limracoin units.
      @note Source: https://en.limracoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LIM,
...
typedef LimracoinUnits::Unit LimracoinUnit;

#endif // LIMRACOIN_QT_LIMRACOINUNITS_H
