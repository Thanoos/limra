...
#ifndef LIMRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LIMRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LIMRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
