...
static void SetupLimracoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " limracoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  limracoin-tx [options] <hex-tx> [commands]  Update hex-encoded limracoin transaction\n" +
            "or:     limracoin-tx [options] -create [commands]   Create hex-encoded limracoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded limracoin transaction
